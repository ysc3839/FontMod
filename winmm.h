...
#define GetAddr(name) _##name = GetProcAddress(hDll, #name);
			...
			//if (_CtfImmAppCompatEnableIMEonProtectedCode && _CtfImmCoUninitialize && _CtfImmDispatchDefImeMessage && _CtfImmEnterCoInitCountSkipMode && _CtfImmGenerateMessage && _CtfImmGetCompatibleKeyboardLayout && _CtfImmGetGlobalIMEStatus && _CtfImmGetGuidAtom && _CtfImmGetIMEFileName && _CtfImmGetTMAEFlags && _CtfImmHideToolbarWnd && _CtfImmIsCiceroEnabled && _CtfImmIsCiceroStartedInThread && _CtfImmIsComStartedInThread && _CtfImmIsGuidMapEnable && _CtfImmIsTextFrameServiceDisabled && _CtfImmLastEnabledWndDestroy && _CtfImmLeaveCoInitCountSkipMode && _CtfImmNotify && _CtfImmRestoreToolbarWnd && _CtfImmSetAppCompatFlags && _CtfImmSetCiceroStartInThread && _CtfImmSetDefaultRemoteKeyboardLayout && _CtfImmTIMActivate && _GetKeyboardLayoutCP && _ImmActivateLayout && _ImmAssociateContext && _ImmAssociateContextEx && _ImmCallImeConsoleIME && _ImmConfigureIMEA && _ImmConfigureIMEW && _ImmCreateContext && _ImmCreateIMCC && _ImmCreateSoftKeyboard && _ImmDestroyContext && _ImmDestroyIMCC && _ImmDestroySoftKeyboard && _ImmDisableIME && _ImmDisableIme && _ImmDisableLegacyIME && _ImmDisableTextFrameService && _ImmEnumInputContext && _ImmEnumRegisterWordA && _ImmEnumRegisterWordW && _ImmEscapeA && _ImmEscapeW && _ImmFreeLayout && _ImmGenerateMessage && _ImmGetAppCompatFlags && _ImmGetCandidateListA && _ImmGetCandidateListCountA && _ImmGetCandidateListCountW && _ImmGetCandidateListW && _ImmGetCandidateWindow && _ImmGetCompositionFontA && _ImmGetCompositionFontW && _ImmGetCompositionStringA && _ImmGetCompositionStringW && _ImmGetCompositionWindow && _ImmGetContext && _ImmGetConversionListA && _ImmGetConversionListW && _ImmGetConversionStatus && _ImmGetDefaultIMEWnd && _ImmGetDescriptionA && _ImmGetDescriptionW && _ImmGetGuideLineA && _ImmGetGuideLineW && _ImmGetHotKey && _ImmGetIMCCLockCount && _ImmGetIMCCSize && _ImmGetIMCLockCount && _ImmGetIMEFileNameA && _ImmGetIMEFileNameW && _ImmGetImeInfoEx && _ImmGetImeMenuItemsA && _ImmGetImeMenuItemsW && _ImmGetOpenStatus && _ImmGetProperty && _ImmGetRegisterWordStyleA && _ImmGetRegisterWordStyleW && _ImmGetStatusWindowPos && _ImmGetVirtualKey && _ImmIMPGetIMEA && _ImmIMPGetIMEW && _ImmIMPQueryIMEA && _ImmIMPQueryIMEW && _ImmIMPSetIMEA && _ImmIMPSetIMEW && _ImmInstallIMEA && _ImmInstallIMEW && _ImmIsIME && _ImmIsUIMessageA && _ImmIsUIMessageW && _ImmLoadIME && _ImmLoadLayout && _ImmLockClientImc && _ImmLockIMC && _ImmLockIMCC && _ImmLockImeDpi && _ImmNotifyIME && _ImmProcessKey && _ImmPutImeMenuItemsIntoMappedFile && _ImmReSizeIMCC && _ImmRegisterClient && _ImmRegisterWordA && _ImmRegisterWordW && _ImmReleaseContext && _ImmRequestMessageA && _ImmRequestMessageW && _ImmSendIMEMessageExA && _ImmSendIMEMessageExW && _ImmSetActiveContext && _ImmSetActiveContextConsoleIME && _ImmSetCandidateWindow && _ImmSetCompositionFontA && _ImmSetCompositionFontW && _ImmSetCompositionStringA && _ImmSetCompositionStringW && _ImmSetCompositionWindow && _ImmSetConversionStatus && _ImmSetHotKey && _ImmSetOpenStatus && _ImmSetStatusWindowPos && _ImmShowSoftKeyboard && _ImmSimulateHotKey && _ImmSystemHandler && _ImmTranslateMessage && _ImmUnlockClientImc && _ImmUnlockIMC && _ImmUnlockIMCC && _ImmUnlockImeDpi && _ImmUnregisterWordA && _ImmUnregisterWordW && _ImmWINNLSEnableIME && _ImmWINNLSGetEnableStatus && _ImmWINNLSGetIMEHotkey)
				return true;
		}
	}
	return false;
